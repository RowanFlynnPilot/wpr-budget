...
const EN = {
  ...
  "s.stat.levyFlat": (prior) => `unchanged from ${prior}`,
  "s.stat.vsPrior": (chg, prior) => `${chg} vs. ${prior}`,
  "wc.levyFlatNote": (prior) => `held flat to the dollar — same total as ${prior}`,
  "wc.rateVsNote": (chg, base, prior) => `${chg} from $${base} in ${prior}`,
  "s.foot.levyFlat": (amt, prior, cur) =>
    `The total tax levy is the same figure both years by design: ${amt} in ${prior} and again in ${cur}. The district's budget book ("Proposed Tax Levy" page) prints the change as $0 (0.00%) — debt-service levy was shifted into the general fund, leaving the total unchanged.`,
  ...
  "s.students.tipPerStudent": "per student",
...
const ES = {
  ...
  "s.stat.levyFlat": (prior) => `sin cambio frente a ${prior}`,
  "s.stat.vsPrior": (chg, prior) => `${chg} frente a ${prior}`,
  "wc.levyFlatNote": (prior) => `se mantuvo exacto al dólar — el mismo total que ${prior}`,
  "wc.rateVsNote": (chg, base, prior) => `${chg} desde $${base} en ${prior}`,
  "s.foot.levyFlat": (amt, prior, cur) =>
    `El impuesto total es la misma cifra ambos años por diseño: ${amt} en ${prior} y de nuevo en ${cur}. El libro presupuestario del distrito (página "Proposed Tax Levy") imprime el cambio como $0 (0.00%) — la recaudación del servicio de deuda se trasladó al fondo general, dejando el total sin cambios.`,
  ...
  "s.students.tipPerStudent": "por estudiante",
...
const HMN = {
  ...
  "s.stat.levyFlat": (prior) => `tsis hloov ntawm ${prior}`,
  "s.stat.vsPrior": (chg, prior) => `${chg} piv rau ${prior}`,
  "wc.levyFlatNote": (prior) => `tuav tsis hloov txog tus duas las — tib tus lej li ${prior}`,
  "wc.rateVsNote": (chg, base, prior) => `${chg} los ntawm $${base} hauv ${prior}`,
  "s.foot.levyFlat": (amt, prior, cur) =>
    `Tus se tag nrho yog tib tus lej ob xyoos raws li lub hom phiaj: ${amt} hauv ${prior} thiab dua hauv ${cur}. Lub koog tsev kawm phau ntawv nyiaj txiag (nplooj "Proposed Tax Levy") luam tawm qhov hloov ua $0 (0.00%) — nyiaj se them nuj nqis raug hloov mus rau general fund, tag nrho tsis hloov.`,
  ...
  "s.students.tipPerStudent": "rau ib tus tub kawm",
